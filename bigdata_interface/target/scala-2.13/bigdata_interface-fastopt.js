...
function $s_LJobScraper__main__AT__V(args) {
  $m_LJobScraper$().main__AT__V(args)
}
/** @constructor */
function $c_LJobScraper$() {
  /*<skip>*/
}
$c_LJobScraper$.prototype = new $h_O();
$c_LJobScraper$.prototype.constructor = $c_LJobScraper$;
/** @constructor */
function $h_LJobScraper$() {
  /*<skip>*/
}
$h_LJobScraper$.prototype = $c_LJobScraper$.prototype;
$c_LJobScraper$.prototype.main__AT__V = (function(args) {
  ...
  var array = ["data engineer", "data scientist", "human resources", "software engineering"];
  var elems = new $c_sjsr_WrappedVarArgs(array);
  var options = $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems);
  var this$5 = $n(options);
  var these = this$5;
  while ((!$n(these).isEmpty__Z())) {
    var arg1 = $n(these).head__O();
    var option = $as_T(arg1);
  ...
  submitButton.onclick = ((arg1$2) => {
    $m_LJobScraper$().JobScraper$$$anonfun$main$2__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_HTMLInputElement__Lorg_scalajs_dom_HTMLSelectElement__Lorg_scalajs_dom_HTMLDivElement__V(arg1$2, fileInput, categorySelect, responseContainer)
  });
  ...
  var ev$1 = document.head;
  ev$1.innerHTML = ($as_T(ev$1.innerHTML) + "\r\n    <style>\r\n      body {\r\n      font-family: Arial, sans-serif;\r\n    max-width: 800px;\r\n    margin: 0 auto;\r\n    }\r\n    h1, p {\r\n    text-align: center;\r\n    }\r\n    input, select, button {\r\n    display: block;\r\n    margin: 10px auto;\r\n}\r\ntable {\r\n  margin: 20px auto;\r\n  border-collapse: collapse;\r\n}\r\ntd, th {\r\n  padding: 5px;\r\n  text-align: left;\r\n}\r\n</style>\r\n")
});
$c_LJobScraper$.prototype.JobScraper$$$anonfun$main$3__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_XMLHttpRequest__Lorg_scalajs_dom_HTMLDivElement__Lorg_scalajs_dom_Node = (function(e, xhr$1, responseContainer$1) {
  var responseText = $as_T(xhr$1.responseText);
  var jsonResponse = JSON.parse(responseText);
  var table = document.createElement("table");
  table.setAttribute("border", "1");
  var len = $uI(jsonResponse.length);
  var i = 0;
  while ((i < len)) {
    var arg1 = jsonResponse[i];
    var tr = document.createElement("tr");
    var array = $m_sjs_js_ArrayOps$().zipWithIndex$extension__sjs_js_Array__sjs_js_Array(arg1);
    var len$1 = $uI(array.length);
    var i$1 = 0;
    while ((i$1 < len$1)) {
      var arg1$1 = array[i$1];
      var x0$1 = $as_T2(arg1$1);
      if ((x0$1 !== null)) {
        var cell = $as_T($n(x0$1).T2__f__1);
        var this$6 = $n(x0$1);
        var index = $uI(this$6.T2__f__2);
        if (((index !== 0) && (index !== 7))) {
  ...
  responseContainer$1.innerHTML = "";
  return responseContainer$1.appendChild(table)
});
$c_LJobScraper$.prototype.JobScraper$$$anonfun$main$2__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_HTMLInputElement__Lorg_scalajs_dom_HTMLSelectElement__Lorg_scalajs_dom_HTMLDivElement__V = (function(e, fileInput$1, categorySelect$1, responseContainer$1) {
  var file = fileInput$1.files[0];
  var selectedCategory = $as_T(categorySelect$1.value);
  var formData = new FormData();
  formData.append("file", file);
  formData.append("category", selectedCategory);
  var xhr = new XMLHttpRequest();
  xhr.open("POST", "http://localhost:8001/check-resume");
  xhr.onload = ((arg1$2) => $m_LJobScraper$().JobScraper$$$anonfun$main$3__Lorg_scalajs_dom_Event__Lorg_scalajs_dom_XMLHttpRequest__Lorg_scalajs_dom_HTMLDivElement__Lorg_scalajs_dom_Node(arg1$2, xhr, responseContainer$1));
  xhr.send(formData)
});
var $d_LJobScraper$ = new $TypeData().initClass({
  LJobScraper$: 0
}, false, "JobScraper$", {
  LJobScraper$: 1,
  O: 1
});
$c_LJobScraper$.prototype.$classData = $d_LJobScraper$;
var $n_LJobScraper$;
function $m_LJobScraper$() {
  if ((!$n_LJobScraper$)) {
    $n_LJobScraper$ = new $c_LJobScraper$()
  };
  return $n_LJobScraper$
}
/** @constructor */
...
$c_sjs_js_ArrayOps$.prototype.zipWithIndex$extension__sjs_js_Array__sjs_js_Array = (function(this$) {
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_LJobScraper__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
//# sourceMappingURL=bigdata_interface-fastopt.js.map
